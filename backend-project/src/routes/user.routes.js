...
router.route("/register").post(
    ...
    router.route("/change-password").patch(uplaod.none(), veryfyJWT, changeCurrentPassword )
    router.route("/change-accountdetails").patch(veryfyJWT , changeaccountdetails )
    router.route("/change-avatar").patch(veryfyJWT ,uplaod.single("avatar"), changeuseravatar )
