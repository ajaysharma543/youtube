...
router.route("/:playlistId/addvideo/:videoId").patch(veryfyJWT, uplaod.none(), addVideoToPlaylist)
router.route("/:playlistId/removevideo/:videoId").patch(veryfyJWT, uplaod.none(), removeVideoFromPlaylist)
