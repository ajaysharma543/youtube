  ...
  return ( 
    <div className="p-4 ">
        <div className='w-[90%] flex justify-end'>
            <button className='font-bold cursor-pointer p-2 rounded-2xl text-blue-400 hover:bg-gray-600' onClick={() => navigate("/Subscription")}>manage</button>
        </div>
     <div className='w-full'>
      ...
      <div className='border-b border-gray-500'>
          <div
          key={video._id}
      className="relative cursor-pointer pb-8 w-[70%]  overflow-hidden shadow-md hover:shadow-lg transition-shadow" onClick={() => navigate(`/video/${video._id}`)}
        >
          <div className="flex items-center gap-3 p-3">
            ...
            />
            <span className="text-white font-semibold">{video.owner.fullname}</span>
          </div>
