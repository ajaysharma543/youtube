...
const handleVerifyOtp = async () => {
  try {
    const res = await OtpApi.verifyOtp({ email: originalEmail, otp: enteredOtp });
 ...
 const onSubmit = async (data) => {
  ...
  setServerError("Please verify OTP from your current email before updating to a new one.");
  setLoading(false);
  return;
}
  ...
  return (
    ...
    {otpSent && <p className="text-green-600 text-sm ">OTP sent successfully!</p>}
