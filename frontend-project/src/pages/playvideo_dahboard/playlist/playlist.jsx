...
import { createPlaylist, getUserPlaylists, setPlaylistError } from "../../../redux/features/playlist";
  ...
  return (
    <div className="relative pl-4" ref={dropdownRef}>
      ...
      {open && !showPlaylistMenu && !createPlaylistMenu && (
        <div className="absolute -top-27 right-0 mt-2 w-44 bg-[#222222] text-white rounded-xl shadow-lg border border-gray-700 z-50">
          <button
